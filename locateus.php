  ...
  height: 100vh;">
	...
	<div class="header">
		<ul>
			...
			<a href="cover.php" style="float: right;">Home</a></li>
		</ul>
	</div>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="background-color: black;">
		<ul style="background-color: black;">			
			<label><b>Search Doctor</b></label>
			<input type="text" name="doctorname" placeholder="Enter Doctor Name"></input>
			<button style="background-color: #00ffff; color: black;" type="submit" style="position:center" name="subd" value="Submit">Submit</button>
		</ul>
		...
		<div class="container">
			<button style="background-color: #00ffff; color: black;" type="submit" style="position:center" name="submit" value="Submit">Submit</button>
		</div>
<?php
session_start();
if(isset($_POST['subd']))
